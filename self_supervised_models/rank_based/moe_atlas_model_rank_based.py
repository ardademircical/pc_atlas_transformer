...
class MoEAtlasModelRankBased(nn.Module):
    """
    ...
    def __init__(self, vocab_size, embed_dim=256, max_seq_len=512, num_layers=6, dropout=0.1):
        super(MoEAtlasModelRankBased, self).__init__()
...
class MoEAtlasEmbeddingsRB(nn.Module):
    def __init__(self, vocab_size, embed_dim=512, max_seq_len=512, dropout=0.1):
        super(MoEAtlasEmbeddingsRB, self).__init__()
...
class MoEAtlasLMHeadRB(nn.Module):
    def __init__(self, vocab_size, embed_dim=256):
        super(MoEAtlasLMHeadRB, self).__init__()
